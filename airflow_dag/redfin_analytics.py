...
# s3 buckets
target_bucket_name = 'msd-redfin-analytics-transformed-data'

# url link from - https://www.redfin.com/news/data-center/
url_city_data = 'https://redfin-public-data.s3.us-west-2.amazonaws.com/redfin_market_tracker/city_market_tracker.tsv000.gz'
...
with DAG('redfin_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://msd-redfin-analytics-raw-data',
        )
